...
FULL_MESSAGE = "ASIYA_CLOSE_001_2026"
...
FILES = {
    "Logcat Output": "forceclose_logs.txt",
    "Meminfo Output": "forceclose_meminfo.txt",
    "Notification Dump": "forceclose_notification_dump.txt",
    "Activity Dump": "forceclose_activity_dump.txt"
}
...
"Force-Close / App Termination Trace": [
    r"force.?stop",
    r"force.?close",
    r"am_force_stop",
    r"am_kill",
    r"\bkilling\b",
    r"\bkilled\b",
    r"stopping com\.instagram\.android",
    r"finish.*com\.instagram\.android",
    r"destroy.*com\.instagram\.android",
    r"remove task",
    r"task removed",
    r"Removing task",
    r"ActivityManager.*com\.instagram\.android",
    r"ActivityTaskManager.*com\.instagram\.android",
    r"ProcessRecord.*com\.instagram\.android"
]
}
...
def main():
    ...
    final_report.append("FORCE-CLOSE APPLICATION ARTIFACT BEHAVIORAL ANALYSIS REPORT")
    final_report.append("=" * 70)
    final_report.append(f"Generated at: {datetime.now()}")
    final_report.append("Experiment Condition: Force-Close Application")
    ...
    output_file = "instagram_force_close_report.txt"
